...
These two services can be substituted entirely assuming they provide the same functionality, whereas the garden's configuration is largely tied to it's physical implementation, which is one of the main reasons that the API and front-end were delegated to third-part providers.
